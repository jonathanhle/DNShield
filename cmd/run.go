// Package cmd implements the command-line interface for DNS Guardian.
...
import (
	...
	"dns-guardian/internal/dns"
	"dns-guardian/internal/proxy"
	"dns-guardian/internal/rules"
...
func NewRunCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:   "run",
		Short: "Run the DNS Guardian agent service",
...
func runAgent(opts *RunOptions) error {
	...
	logrus.Info("Starting DNS Guardian")
	...
	logrus.Info("DNS Guardian is running")
	...
	logrus.Info("DNS Guardian stopped")
	return nil
}
